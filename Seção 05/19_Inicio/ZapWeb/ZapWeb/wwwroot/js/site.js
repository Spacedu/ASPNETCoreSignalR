...
function MonitorarListaUsuarios() {
    ...
    connection.on("ReceberListaUsuarios", function (usuarios) {
        ...
        for (i = 0; i < usuarios.length; i++) {
            html += '<div class="container-user-item"><img src = "/imagem/logo.png" style = "width: 20%;" /><div><span>' + usuarios[i].nome + ' (' + (usuarios[i].isOnline ? "online" : "offline") + ')</span><span class="email">' + usuarios[i].email + '</span></div></div >'
        }
